...
const SCHEMA = {
  ...
  bs: [
    ...
    { key: "receivables", label: "営業債権", group: "資産",
      aliases: ["売上債権", "売掛金", "受取手形", "受取手形及び売掛金", "売掛金及び受取手形", "売上債権(純額)"] },
    ...
    { key: "payables", label: "営業債務", group: "負債",
      aliases: ["仕入債務", "買掛金", "支払手形", "支払手形及び買掛金", "買掛金及び支払手形"] },
    ...
    { key: "longLoans", label: "長期借入金", group: "負債",
      aliases: ["長期借入", "社債"] },
    { key: "otherFixedLiab", label: "その他固定負債", group: "負債",
      aliases: ["その他の固定負債", "固定負債その他", "長期未払金", "資産除去債務"] },
    { key: "retirementBenefits", label: "退職給付引当金", group: "負債",
      aliases: ["退職給付に係る負債", "退職給付債務", "退職給付引当金等"] },
